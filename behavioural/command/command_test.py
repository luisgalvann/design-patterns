...
class AbstractCommandTest(TestCase):
    ...
    def test_abstract_instantiation_error(self):
        ...
        msg = "Can't instantiate abstract class ICommand with abstract methods __init__, execute"
    ...
    def test_abstract_inheritance_error(self):
        ...
        msg = "Can't instantiate abstract class NewClass with abstract methods __init__, execute"
        self.assertEqual(msg, str(cm.exception))
